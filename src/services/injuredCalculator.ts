 ...
 */
export function shouldBeInjured(currentWounds: number, maxWounds: number): boolean {
 ...
 */
export function getModifiedMovement(baseMovement: number, isInjured: boolean): number {
 ...
 */
export function getModifiedHitStat(baseHit: number, isInjured: boolean): number {
