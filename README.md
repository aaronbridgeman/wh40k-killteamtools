...
- **Game Runner**: Default tab with team setup panes, a reset/draw activation deck flow, current-activation operative lists, and operative runner cards shown only for activated operatives
